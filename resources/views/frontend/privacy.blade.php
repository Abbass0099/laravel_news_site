...
<html>
	...
	<body>
						...
						<nav class="navbar navbar-expand-lg navbar-light ">
							...
							<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
								<div class="navbar-nav">
									...
									<a class="nav-item nav-link active" href="/single">تفاصيل المقال</a>
		...
		<div class="top-section" data-aos="fade-up" data-aos-duration="800">
			<div class="container">
				<h1 class="title text-center">سياسة الخصوصية</h1>
		...
		<div class="container">
			<div class="page">
				...
				<h4>الروابط بالمواقع الأخرى على شبكة الإنترنت</h4>
				<p>
