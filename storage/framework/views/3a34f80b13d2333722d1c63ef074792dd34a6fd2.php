...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1>
            Create Category
            <small><a href="<?php echo e(route('admin.category.index')); ?>" class="btn btn-block btn-xs btn-warning btn-flat"><i class="fa fa-plus"></i> BACK</a></small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            ...
            <form action="<?php echo e(route('admin.category.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                <?php echo csrf_field(); ?>
